...
namespace FL.Ebolapp.Shared.Infrastructure
{
    ...
    {
        private static readonly Lazy<IDictionary<string, string>> _mappings = new Lazy<IDictionary<string, string>>(MimeTypeMap.BuildMappings);
        ...
        public static string GetMimeType(string extension)
        {
            ...
            return MimeTypeMap._mappings.Value.TryGetValue(extension, out var mime)
                ? mime
                : "application/octet-stream";
        }

        public static string GetExtension(string mimeType)
            => MimeTypeMap.GetExtension(mimeType, true);
        ...
        public static string GetExtension(string mimeType, bool throwErrorIfNotFound)
        {
            ...
            if (MimeTypeMap._mappings.Value.TryGetValue(mimeType, out var extension))
            {
                return extension;
            }
